...
| GitHub | `stage/02-domain-models`; PR #8; deployment evidence | BLOCKED | Head `99b366655c0b2374952740d9ed329e9584a38564` has CI PASS, but Codex returned CR-02-034. The latest pushed documentation evidence refresh must be CI-passed and reviewed by Codex with no major issues before Gate 6 can pass. |
