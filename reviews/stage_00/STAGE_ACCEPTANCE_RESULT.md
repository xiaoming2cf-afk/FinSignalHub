...
| GitHub | `deployments/stage_00/GITHUB_PR.md`, PR #1, CI checks, `reviews/stage_00/CODEX_REVIEW_SUMMARY.md` | BLOCKED | PR exists, CI passed, and Codex review returned one P1 and two P2 findings; fixes must be pushed and reviewed again |
