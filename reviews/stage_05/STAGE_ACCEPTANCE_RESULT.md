...
| Logs | PASS locally | CONTROL and RUNLOG updates through A-0528/CP-0389 after CR-05-009 local checks | Append-only evidence updated; latest rows are the source of truth after this relation-compatibility refresh |
| GitHub | BLOCKED | `deployments/stage_05/GITHUB_PR.md` | PR #12 exists; current relation-compatibility refresh head still needs CI PASS, current-head Codex no-major, and unresolved review threads = 0 |
