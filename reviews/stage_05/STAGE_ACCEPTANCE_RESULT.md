...
| Logs | PASS locally | CONTROL and RUNLOG updates through A-0530/CP-0391 after CR-05-010 local checks | Append-only evidence updated; latest rows are the source of truth after this migration-gate refresh |
| GitHub | BLOCKED | `deployments/stage_05/GITHUB_PR.md` | PR #12 exists; current non-enum relation migration-gate refresh head still needs CI PASS, current-head Codex no-major, and unresolved review threads = 0 |
