...
Last reviewed head before this acceptance-source refresh:

`e716ff14992aafb39136d840ed6037a4b05b4a42`

That head passed CI, and Codex opened CR-05-006/007 because the Stage 05 acceptance result pointed the next-stage gate at stale `CONTROL/15` current state and the PR body still cited older gate evidence. The next pushed head containing this acceptance-source refresh must pass CI, receive current-head Codex no-major, and have unresolved review threads = 0 before Gate 6 can pass.
