...
- Codex CR-03-042 and CR-03-043 remediation:
  - arXiv raw ids, versioned ids, `arXiv:` prefixed ids, abs URLs, and PDF URLs normalize to stable `arxiv:<id>` source identity;
  - old-style dotted arXiv archive classes such as `physics.ins-det/0301001` and `physics.atom-ph/9901001` normalize to stable `arxiv:<old_id>` source identity;
