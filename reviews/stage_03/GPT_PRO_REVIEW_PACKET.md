...
- Remediated Codex CR-03-043 by supporting old-style dotted arXiv archive classes such as `physics.ins-det/0301001` and `physics.atom-ph/9901001`; reviewed code head `adb41c36e66a25ddfa943950b7e08a685906560e` passed PR #10 CI, received current-head Codex no-major evidence, and received GPT Pro CR-03-043 re-review PASS.
