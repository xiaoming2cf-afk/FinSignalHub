...
| GitHub | BLOCKED BY CR-03-012 | Remediation PR head `a65a6d022758ef005d411b460f5aeb7e1ed26c77` passed both Stage Governance CI jobs, but Codex review `4395338983` returned CR-03-012. The next evidence correction must receive CI PASS and Codex recheck before Gate 6 can pass again. |
