...
| GitHub | BLOCKED BY CR-03-013 | PR body evidence correction head `c86e5b99f556228a9f06b85234b376c52417f51d` passed both Stage Governance CI jobs, but Codex review `4395358671` returned CR-03-013. The next evidence correction must receive CI PASS and Codex recheck before Gate 6 can pass again. |
