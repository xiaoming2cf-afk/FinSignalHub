...
| GitHub | BLOCKED BY CR-03-014/015 | Current-state evidence correction head `4fd9278db518747d93e968518680783d6310f74e` passed both Stage Governance CI jobs, but Codex reviews `4395370803` and `4395376770` returned CR-03-014/015. The next evidence correction must receive CI PASS and Codex recheck before Gate 6 can pass again. |
