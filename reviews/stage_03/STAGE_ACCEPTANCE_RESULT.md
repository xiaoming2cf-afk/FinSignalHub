...
| GitHub | BLOCKED BY CR-03-010/011 | Blocker-evidence PR head `f9b2e3067d123dc915ffe2977cb448f3008b0294` passed both Stage Governance CI jobs, but Codex review `4395247885` returned CR-03-010 and CR-03-011. Local remediation must be pushed and the new live head must receive CI PASS and Codex recheck before Gate 6 can pass again. |
