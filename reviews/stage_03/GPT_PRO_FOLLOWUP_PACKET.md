...
- As of this packet refresh, CR-03-001 through CR-03-019 are historical/resolved or superseded in sequence, and CR-03-020/B-0057 is the active GitHub/Codex blocker until the acceptance-result live-head evidence refresh passes CI and receives Codex recheck. Treat this line as historical after any later commit and verify the live summary before submission.
