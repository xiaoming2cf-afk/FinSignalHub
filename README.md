...
Stage 00 status: control system setup in progress. No product runtime, backend, database, connector, frontend, MCP tool, dashboard, report generator, stock recommender, or RAG system has been implemented.
