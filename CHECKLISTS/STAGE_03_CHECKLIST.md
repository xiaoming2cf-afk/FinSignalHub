...
| GitHub | Branch, PR, CI, Codex review, PR URL | BLOCKED by CR-03-012. Remediation head `a65a6d022758ef005d411b460f5aeb7e1ed26c77` passed CI, but Codex review `4395338983` returned a PR body CI-evidence finding. The next evidence correction must pass CI and Codex recheck before Gate 6 can pass. |
