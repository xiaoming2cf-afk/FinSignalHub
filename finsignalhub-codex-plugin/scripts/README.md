...
- `phase_check.py`: validates required governance artifacts, rejects unknown stage ids, and recursively blocks forbidden Stage 00/00.1 runtime scaffold paths outside `.git`.
