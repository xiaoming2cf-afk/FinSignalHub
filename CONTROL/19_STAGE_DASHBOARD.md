...
| 03 | planning active; local checks passed | `stage/03-source-connectors` | pending | local planning checks PASS; GitHub CI pending PR | pending PR | pending plan review | B-0028 blocks implementation until Stage 03 GitHub/Codex and GPT Pro plan gates pass | GPT Pro Stage 02 final instruction |
