...
| 04 | active / planning-only; CR-04-007 remediation local | `stage/04-evidence-extraction` | https://github.com/xiaoming2cf-afk/FinSignalHub/pull/11 | PASS for reviewed heads through `ebab55f`; remediation head pending | BLOCKED by CR-04-001 through CR-04-007 until remediation head gets current-head no-major | pending Stage 04 plan review packet submission | B-0076 open; implementation not authorized | Stage 03 GPT Pro CR-03-043 PASS; Stage 04 plan review required |
