...
| 04 | active / planning-only; live PR #11 Gate 6 recheck | `stage/04-evidence-extraction` | https://github.com/xiaoming2cf-afk/FinSignalHub/pull/11 | Live PR #11 current-head checks decide Gate 6; reviewed heads through `b1e21b8` have CI PASS | BLOCKED by CR-04-001 through CR-04-009 until live PR #11 current head gets Codex no-major or all new findings are handled | pending Stage 04 plan review packet submission | B-0076 open; implementation not authorized | Stage 03 GPT Pro CR-03-043 PASS; Stage 04 plan review required |
