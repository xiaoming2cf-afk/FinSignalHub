...
| 03 | planning active; blocked at external review gates | `stage/03-source-connectors` | https://github.com/xiaoming2cf-afk/FinSignalHub/pull/9 | PASS: governance checks `26671983662` and `26671988731` | BLOCKED: Codex environment required | BLOCKED: background Chrome route `native pipe is closed` | B-0028 blocks implementation; B-0029 blocks Codex review; B-0030 blocks GPT Pro submission | GPT Pro Stage 02 final instruction |
