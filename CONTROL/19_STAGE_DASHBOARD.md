...
| 04 | current-head GPT Pro PASS captured / B-0106 live Gate 6 blocked | `stage/04-evidence-extraction` | https://github.com/xiaoming2cf-afk/FinSignalHub/pull/11 | Use live PR #11 head after latest B-0106 evidence-sync patch; prior `cb95156`/`31070376` heads are not final evidence | Use current-head Codex result for live PR #11 head; prior CR-04-044/045 are handled follow-ups | PASS for current-head final review; Stage 05 planning-only authorized after live Gate 6 refresh | B-0106 open / live-head gate pending; B-0105 superseded | GPT Pro authorized Stage 05 planning only |
| 05 | planned / planning-only authorized after Stage 04 B-0106 live gate passes | not created | none | none | none | none | waiting Stage 04 latest live PR head CI/Codex/thread gate | GPT Pro Stage 04 current-head final response plus B-0106 live Gate 6 |
