...
| 03 | planning active; CR-03-001 fixed locally | `stage/03-source-connectors` | https://github.com/xiaoming2cf-afk/FinSignalHub/pull/9 | PASS on last pushed head; follow-up pending after CR-03-001 fix push | BLOCKED: CR-03-001 follow-up pending | BLOCKED: background Chrome route `native pipe is closed` | B-0028 blocks implementation; B-0030 blocks GPT Pro submission; B-0031 blocks Codex follow-up | GPT Pro Stage 02 final instruction |
