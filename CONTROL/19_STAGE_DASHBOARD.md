...
| 04 | active / planning-only; local checks PASS | `stage/04-evidence-extraction` | pending | local planning checks PASS; PR CI pending | pending PR and `@codex review` | pending Stage 04 plan review packet submission | none blocking local planning; implementation not authorized | Stage 03 GPT Pro CR-03-043 PASS; Stage 04 plan review required |
