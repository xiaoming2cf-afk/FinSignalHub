...
| 04 | current-head GPT Pro PASS captured / B-0104 local checks PASS / external Gate 6 pending | `stage/04-evidence-extraction` | https://github.com/xiaoming2cf-afk/FinSignalHub/pull/11 | `3fcc058` CI PASS; CR-04-042 route remediation pending live Gate 6 after push | `3fcc058` Codex opened CR-04-042; local remediation changes current-state to conditional live PR routing and passed CP-0363 local checks | PASS for current-head final review; Stage 05 planning-only authorized after live Gate 6 refresh | B-0104 open / local checks passed / external gate pending; B-0103 superseded | GPT Pro authorized Stage 05 planning only |
| 05 | planned / planning-only authorized after Stage 04 B-0104 live gate passes | not created | none | none | none | none | waiting Stage 04 B-0104 remediation head CI/Codex/thread gate | GPT Pro Stage 04 current-head final response plus B-0104 live Gate 6 |
