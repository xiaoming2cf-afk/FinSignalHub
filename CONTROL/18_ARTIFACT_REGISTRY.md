...
| A-0003 | 00 | review packet | reviews/stage_00/GPT_PRO_REVIEW_PACKET.md | created, not submitted | gpt-pro-review-preparer | GPT Pro gate |
| A-0004 | 00 | PR body | reviews/stage_00/PR_BODY.md | created | github-stage-deployer | GitHub gate |
| A-0005 | 00 | GitHub PR | deployments/stage_00/GITHUB_PR.md | blocked | github-stage-deployer | GitHub gate |
...
| A-0015 | 00 | local Git commit | `stage-00: establish control system` on `stage/00-control-system`; confirm hash with `git log --oneline -1` | created locally, not pushed | github-stage-deployer | GitHub gate partial evidence |
