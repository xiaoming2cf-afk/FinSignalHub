...
| A-0070 | 01 | Stage 01 PR | https://github.com/xiaoming2cf-afk/FinSignalHub/pull/7 | open; CI and Codex review must be rechecked after each push; latest Docker-evidence update passed CI before this status fix | github-stage-deployer | Stage 01 planning PR evidence |
...
| A-0079 | 01 | Stage 01 Codex review summary | reviews/stage_01/CODEX_REVIEW_SUMMARY.md | updated through CR-01-027; current-head follow-up pending after push | github-review-resolver | Stage 01 plan Codex gate |
