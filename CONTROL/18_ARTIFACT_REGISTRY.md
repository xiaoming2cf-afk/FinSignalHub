...
| A-0056 | 00.1 | PR #6 safe export P2 finding | https://github.com/xiaoming2cf-afk/FinSignalHub/pull/6#discussion_r3295180243 | fixed locally by restricting exports to new files under `artifacts/`; push, CI, and follow-up Codex review pending | github-review-resolver | Stage 00.1 GitHub/Codex gate |
| A-0057 | 00.1 | PR #6 future-stage phase-check P2 finding | https://github.com/xiaoming2cf-afk/FinSignalHub/pull/6#discussion_r3295180241 | fixed locally by adding `--final` mode; push, CI, and follow-up Codex review pending | github-review-resolver | Stage 00.1 GitHub/Codex gate |
