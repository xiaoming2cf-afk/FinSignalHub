...
| A-00.1-004 | 00.1 | Run local governance checks and open PR | A-00.1-003 | governance files only | github-stage-deployer, github-review-resolver | none | PR URL, CI status, Codex review | CI passes and Codex responds | in progress |
