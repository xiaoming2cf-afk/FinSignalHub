...
| A-01-001 | 01 | Draft Stage 01 plan | Stage 00.1 PASS plus current-head Codex no-major evidence | `PLANS/STAGE_01_PLAN.md`, `reviews/stage_01/` | finsignal-product-governor, gpt-pro-review-preparer | planning subagents only if needed | Stage 01 plan packet | GPT Pro plan review packet ready | in progress: plan packet created; GPT Pro submission pending |
