...
| A-00.1-004 | 00.1 | Run local governance checks and open PR | A-00.1-003 | governance files only | github-stage-deployer, github-review-resolver | none | PR URL, CI status, Codex review | CI passes and Codex responds | in progress: PR opened; initial P2 findings fixed locally |
| A-00.1-005 | 00.1 | Submit GPT Pro review and close Stage 00.1 | A-00.1-004 | `reviews/stage_00_1/`, `CONTROL/15`, logs | browser-gpt-pro-reviewer, stage-next-goal-synthesizer, phase-gate-auditor | none | GPT response, action items, final gate result | GPT Pro PASS or documented blocker | pending |
