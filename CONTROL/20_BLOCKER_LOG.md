...
| B-0009 | 2026-05-24T11:41:00-05:00 | 01 | Docker daemon | open | Docker CLI exists, but daemon is not reachable at `npipe:////./pipe/dockerDesktopLinuxEngine` | Stage 01 implementation is blocked until Docker Desktop is running and revalidated; Stage 00.1 can continue | user starts Docker Desktop, then Codex reruns Docker validation | yes | user/Codex |
