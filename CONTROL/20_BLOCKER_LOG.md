...
| B-0021 | 2026-05-29T16:11:38-05:00 | 02 | Final documentation evidence Codex follow-up | open | Codex reviewed final evidence head `b80ad20623531005eb6b966608cebb22d8332731` and returned CR-02-037 because `CONTROL/18_ARTIFACT_REGISTRY.md` registered untracked screenshot paths as acceptance evidence. | PR #8 final evidence cannot be merged until the registry points only to committed evidence and the next pushed head passes CI/Codex. | Remove screenshot paths from the artifact registry and rely on committed textual GPT Pro response files; push, wait for CI, and request follow-up Codex. | no | Codex |
