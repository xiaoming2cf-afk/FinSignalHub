...
| B-0020 | 2026-05-29T13:35:00-05:00 | 02 | Final implementation GitHub/GPT Pro gates | open | Delayed Codex review on head `9c4e5d35556eb2115ccb333185f50a2889a02c33` returned CR-02-030/031. Local remediation now enables SQLite foreign keys, rejects orphan project-scoped creates, validates ClaimEvidenceEdge `source_artifact_refs`, and rejects unknown refs, but it must still be committed, pushed, pass live CI, and receive current-head Codex no-major evidence. Chrome GPT Pro automation also failed with `native pipe is closed` after extension/native-host checks passed and a recovery window was opened | Stage 02 cannot be marked PASS and Stage 03 cannot begin | push remediation; keep Codex gate pending until no-major evidence exists; repair or recover Chrome extension route for GPT Pro final review; never treat missing Codex/GPT response as pass | no unless GPT Pro page or Chrome recovery requires login/permission/secret input | Codex/GPT Pro |
