...
| R-015 | Implementation evidence reused from stale PR head | high | prior CI/Codex PASS is cited after new scaffold files are created | record B-0015; require current-head CI and Codex after implementation push | GitHub stage deployer | open |
