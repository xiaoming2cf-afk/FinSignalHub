...
3. If the remediation external gate passes, merge/tag Stage 04 according to the release protocol without creating another evidence-only commit solely to restate live CI/Codex status.
